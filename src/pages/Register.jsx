...
const Register = () => {
    ...
    return (
        <div className="min-h-screen flex items-center justify-center bg-[#F0F9FF] pt-32 pb-12 px-4 sm:px-6 lg:px-8">
                ...
                <form className="mt-8 space-y-6" onSubmit={handleSubmit}>
                        ...
                        <div>
                            ...
                            <div className="relative">
                                <div className="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none z-20">
                                    <User className="h-5 w-5 text-[#00C8FA]" aria-hidden="true" />
                                </div>
                                <input
                                    id="fullName"
                                    name="fullName"
                                    type="text"
                                    required
                                    className={`appearance-none rounded-xl relative block w-full px-3 py-3 pl-10 border ${errors.fullName ? 'border-red-500' : 'border-gray-300'} placeholder-gray-500 text-gray-900 focus:outline-none focus:ring-2 focus:ring-[#00C8FA] focus:border-transparent focus:z-10 sm:text-sm transition-colors duration-200 bg-gray-50 hover:bg-white`}
                                    placeholder="Full Name"
                                    value={formData.fullName}
                                    onChange={handleChange}
                                />
                            </div>
                            {errors.fullName && <p className="mt-1 text-xs text-red-500 pl-1">{errors.fullName}</p>}
                        </div>
                        ...
                        <div>
                            ...
                            <div className="relative">
                                ...
                                <input
                                    ...
                                    autoComplete="new-password"
                                    required
                                    className={`appearance-none rounded-xl relative block w-full px-3 py-3 pl-10 pr-10 border ${errors.confirmPassword ? 'border-red-500' : 'border-gray-300'} placeholder-gray-500 text-gray-900 focus:outline-none focus:ring-2 focus:ring-[#00C8FA] focus:border-transparent focus:z-10 sm:text-sm transition-colors duration-200 bg-gray-50 hover:bg-white`}
                    ...
                    <div className="text-center mt-4">
                        <p className="text-sm text-gray-600">
                            ...
                            <Link to="/login" className="font-bold text-[#00C8FA] hover:text-[#00b0dc] transition-colors">
                                Sign in
                            </Link>
                        </p>
                    </div>
